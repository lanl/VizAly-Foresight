...
def saveScreenshot(inputFilename, regName, outputName):
    ...
    resampleToImage2Display.ScaleTransferFunction.Points = [-32.0278434753418, 0.0, 0.5, 0.0, 1121.8330078125, 1.0, 0.5, 0.0]

    # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
    resampleToImage2Display.OpacityTransferFunction.Points = [-32.0278434753418, 0.0, 0.5, 0.0, 1121.8330078125, 1.0, 0.5, 0.0]
