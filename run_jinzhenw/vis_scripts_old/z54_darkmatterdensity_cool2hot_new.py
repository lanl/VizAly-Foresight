...
def saveScreenshot(inputFilename, regName, outputName):
    ...
    native_fieldsdark_matter_densityLUT.RGBPoints = [0.780715771484375, 0.0, 1.0, 1.0, 173.12100219726562, 0.0, 0.0, 1.0, 313.5464172363281, 0.0, 0.0, 0.501960784314, 492.2696838378906, 1.0, 0.0, 0.0, 7807.15771484375, 1.0, 1.0, 0.0]
    ...
    # native_fieldsdark_matter_densityPWF.Points = [0.0, 0.0, 0.5, 0.0, 150.5466079711914, 1.0, 0.5, 0.0, 7807.15771484375, 1.0, 0.5, 0.0]
    native_fieldsdark_matter_densityPWF.Points = [0.780715771484375, 0.0, 0.5, 0.0, 154.6009521484375, 0.9732620716094971, 0.5, 0.0, 7807.15771484375, 1.0, 0.5, 0.0]
    ...
    resampleToImage1Display.ScaleTransferFunction.Points = [-32.0278434753418, 0.0, 0.5, 0.0, 1121.8330078125, 1.0, 0.5, 0.0]

    # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
    resampleToImage1Display.OpacityTransferFunction.Points = [-32.0278434753418, 0.0, 0.5, 0.0, 1121.8330078125, 1.0, 0.5, 0.0]
