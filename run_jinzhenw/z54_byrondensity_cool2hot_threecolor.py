...
def saveScreenshot(inputFilename, regName, outputName):
    ...
    renderView1.CameraPosition = [256.0, 256.0, 1969.1853900550307]
    ...
    native_fieldsbaryon_densityLUT.RGBPoints = [0.06377197802066803, 0.0, 1.0, 1.0, 422.0646667480469, 0.0, 0.0, 1.0, 855.787841796875, 0.0, 0.0, 0.501960784314, 1289.5108642578125, 1.0, 0.0, 0.0, 1934.2344970703125, 1.0, 0.984313725490196, 0.0, 28918.84765625, 1.0, 1.0, 0.0]
    ...
    native_fieldsbaryon_densityPWF.Points = [0.06377197802066803, 0.0, 0.5, 0.0, 82.1195068359375, 0.9411764740943909, 0.5, 0.0, 28918.84765625, 1.0, 0.5, 0.0]
