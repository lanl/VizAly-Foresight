...
int main(int argc, char * argv[])
{
    ...
    if(argc < 3)
    {
	printf("Test case: testfloat_compress_subblock [config_file] [srcFilePath] [dimension sizes...]\n");
	printf("Example: testfloat_compress_subblock sz.config testfloat_8_8_128.dat 8 8 128\n");
	exit(0);
    }
    ...
    cost_start();
    SZ_compress_args3(SZ_FLOAT, data, bytes, &outSize, REL, 1E-3, 1E-3, r5, r4, r3, r2, r1, 0, 0, 0, 0, 0, 10, 10, 10, 10, 10);
	cost_end();
    printf("timecost=%f\n",totalCost); 
