...
def diagnostics_np(net_vel, true_vel, save_dir='./diagnosticsArvind/', iteration=2, pos=[0,0,2], dx=[0.1, 0.1, 0.1], diagnostics=['spectrum', 'intermittency', 'structure_functions', 'QR', 'image']):
